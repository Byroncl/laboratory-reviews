      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-500 text-sm mb-1">Posts Totales</p>
          ...
          <p class="text-green-600 text-sm mt-2">+5.2% vs último mes</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-6">
          ...
          <p class="text-green-600 text-sm mt-2">+12.5% vs último mes</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-500 text-sm mb-1">Usuarios Activos</p>
              <p class="text-3xl font-bold text-primary">892</p>
            </div>
            <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
              <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292m15 2.646a9 9 0 11-18 0m0 0a9 9 0 1018 0z"></path>
              </svg>
            </div>
          </div>
          <p class="text-green-600 text-sm mt-2">+8.1% vs último mes</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-500 text-sm mb-1">Crecimiento</p>
              <p class="text-3xl font-bold text-primary">+24.8%</p>
            </div>
          ...
          <p class="text-green-600 text-sm mt-2">En aumento</p>
        </div>
      </div>
